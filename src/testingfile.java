...
public class testingfile {
	...
	public static void main(String[] args) throws Exception {
		...
		Student _student1 = new Student("John Cena", "A1800123B", "Singaporean", "SCSE", 'M', 1, "loginID_1", "loginPW_1", "wong1173@e.ntu.edu.sg");

		Student _student2 = new Student("TRUMPET", "C1283713D", "Singaporean", "SCSE", 'M', 3, "loginID_2", "loginPW_2", "wong1173@e.ntu.edu.sg");

		Student _student3 = new Student("BIDEN", "E2938173F", "Malaysian", "SEEE", 'F', 2, "loginID_3", "loginPW_3", "wong1173@e.ntu.edu.sg");

		Student _student4 = new Student("BEIBER", "G2938717H", "Myanmar", "SCEE", 'F', 5, "loginID_4", "loginPW_4", "wong1173@e.ntu.edu.sg");

		Student _student5 = new Student("MICHELLE", "I29836721J", "Chinese", "SEEE", 'M', 2, "loginID_5", "loginPW_5", "wong1173@e.ntu.edu.sg");

		Student _student6 = new Student("RONALD", "K1928363L", "Chinese", "SEEE", 'F', 2, "loginID_6", "loginPW_6", "wong1173@e.ntu.edu.sg");

		Student _student7 = new Student("Ya Fei", "M12345678N", "Malaysian", "SMSE", 'M', 2, "loginID_7", "loginPW_7", "wong1173@e.ntu.edu.sg");

		Student _student8 = new Student("Wei Run", "O98765432P", "Chinese", "SCSE", 'M', 2, "loginID_8", "loginPW_8", "wong1173@e.ntu.edu.sg");

		Student _student9 = new Student("Alex Tan", "Q34123214R", "American", "SMSE", 'M', 2, "loginID_9", "loginPW_9", "wong1173@e.ntu.edu.sg");

		Student _student10 = new Student("Wonder Fei", "S29836721T", "British", "SMSE", 'M', 2, "loginID_10", "loginPW_10", "wong1173@e.ntu.edu.sg");
