...
public class CourseManager {
	...
	public static Course findCourseObject(String courseID) {
		...
		return emptycourse; //NOTE: STRING DEFAULTS ARE NULL, HENCE TO CHECK IF OBJECT IS EMPTY, CHECK IF A STRING ATTRIBUTE IS NULL
	}
	...
	public boolean addStudent(Student Student,String courseID, String indexID) {
